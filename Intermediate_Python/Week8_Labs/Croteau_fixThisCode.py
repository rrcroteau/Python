#DIRECTIONS: Fix the code below to get it to run correctly based on the starting documentation program description.

#This program utilizes: 'textFile.txt'
...
#1 - connect to a file and import its data into lists
with open("Week8_Labs/textFile.txt") as csvfile:
...
#after the bubble sort we can use info on lines 142 and 143 to find the youngest/oldest
