...
#flip all '\' to '/'
with open("DemosNotes/W2D1_TFH/example.csv") as csvfile:
    ...
    for rec in file:
        ...
        #print(f"RECORD#: {total_records}\tNAME: {name}")  
        #print(f"RECORD#: {total_records}\tNAME: {rec[0]}")  

        print(f"\t\t{name:8}\t{age:3}\t${salary:7,.2f}")    
...
print(f"TOTAL SALARIES of ALL EMPLOYEES: ${total_salaries:,.2f}")